...
const NodeCommonOpts: BuildOptions = {
    ...
    define: {
        ...
        Moggcord_GIT_HASH: JSON.stringify(gitHash)
    }
};
...
await Promise.all([
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/moggcord/main/index.ts"],
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/moggcord/preload/index.ts"],
        outfile: "dist/js/preload.js",
        footer: { js: "//# sourceURL=VesktopPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/moggcord/preload/splash.ts"],
        outfile: "dist/js/splashPreload.js",
        footer: { js: "//# sourceURL=VesktopSplashPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/moggcord/preload/updater.ts"],
    ...
    createContext({
        ...CommonOpts,
        globalName: "Equibop",
        entryPoints: ["src/moggcord/renderer/index.ts"],
        outfile: "dist/js/renderer.js",
        format: "iife",
        inject: ["./scripts/build/injectReact.mjs"],
        jsxFactory: "VencordCreateElement",
        jsxFragment: "VencordFragment",
        external: ["@Moggcord/types/*", "@moggcord/types/*"],
        plugins: [vencordDep, includeDirPlugin("patches", "src/moggcord/renderer/patches")],
