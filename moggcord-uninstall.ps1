# ==============================================================================
#  Moggcord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Moggcord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Moggcord-Client"
...
Write-Host "  ║      MOGGCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Moggcord désinstallé avec succès !                 │" -ForegroundColor Green
