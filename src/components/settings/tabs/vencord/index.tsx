...
import { ContributeModal } from "../../../../moggcord/renderer/components/ContributeModal";
        ...
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="Mogged Site"
                    action={() => window.open("https://moggcord.online", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("moggcord-stealth-change", handler);
        return () => window.removeEventListener("moggcord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all Moggcord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all Moggcord visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Moggcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Moggcord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all Moggcord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "Moggcord Settings");
