...
import { Logger } from "@Moggcord/types/utils";
import { findLazy, onceReady } from "@Moggcord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Moggcord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("MoggcordRPC", "#5865f2");
