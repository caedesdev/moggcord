...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Moggcord/types/components";
import { FluxDispatcher, InviteActions } from "@Moggcord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Moggcord and Moggcord are fully up to date. You can get help in our{" "}
