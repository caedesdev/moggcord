...
import {
    ...
    RestartIcon,
    Span
} from "@Moggcord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Moggcord/types/webpack/common";
...
const logger = new Logger("MoggcordScreenShare");
