...
import { BaseText, Button, FormSwitch } from "@Moggcord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Moggcord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`moggcord://assets/${asset}?v=${version}`}
                    alt=""
