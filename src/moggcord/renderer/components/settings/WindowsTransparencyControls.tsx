...
import { Heading, Paragraph } from "@Moggcord/types/components";
import { Margins } from "@Moggcord/types/utils";
import { Select } from "@Moggcord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Moggcord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
