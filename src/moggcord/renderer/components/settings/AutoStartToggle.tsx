...
import { useState } from "@Moggcord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Moggcord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Moggcord minimized when starting with system"}
