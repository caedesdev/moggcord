...
import { Button, Card, HeadingTertiary, Paragraph } from "@Moggcord/types/components";
import { useAwaiter } from "@Moggcord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Moggcord is outdated!</HeadingTertiary>
