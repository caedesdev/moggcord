...
import { Button, Flex, Heading, Paragraph } from "@Moggcord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot, ModalSize } from "@Moggcord/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        MoggcordFr is a 100% Free product.
                    </Paragraph>
                ...
                <div style={{
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        <li style={{ marginBottom: "6px", color: "var(--text-normal)" }}>
                            <strong>Owner:</strong> Caedes
                        </li>
                        <li style={{ color: "var(--text-normal)" }}>
                            <strong>Mogged Site:</strong>{" "}
                            <span
                                style={{ color: "var(--text-link)", cursor: "pointer" }}
                                onClick={() => window.open("https://moggcord.online", "_blank")}
                            >
                                moggcord.online
                            </span>
                        </li>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download MoggcordFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
