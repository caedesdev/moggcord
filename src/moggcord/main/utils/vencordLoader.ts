...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/caedesdev/moggcord/releases/latest/download/Moggcord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Moggcord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled moggcord.asar not found at", VENCORD_DIR);
    }
}
