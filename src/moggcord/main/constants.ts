...
const MoggcordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(MoggcordDir, "Uninstall Moggcord.exe"));

export const DATA_DIR =
    process.env.Moggcord_USER_DATA_DIR || (PORTABLE ? join(MoggcordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Moggcord/${app.getVersion()} (https://github.com/caedesdev/moggcord)`;
