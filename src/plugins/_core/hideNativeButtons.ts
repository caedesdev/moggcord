/*
 * Moggcord — Injection CSS globale pour masquer les boutons natifs Discord
 */

import { Devs } from "@utils/constants";
import definePlugin from "@utils/types";

const STYLE_ID = "moggcord-hide-native-buttons";

const CSS = `
/* ── Moggcord : suppression boutons natifs Discord non désirés ── */
