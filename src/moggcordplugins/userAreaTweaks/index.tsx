...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for Moggcord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "Moggcord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "moggcord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("moggcord-userarea-tweaks-style")?.remove();
    }
});
