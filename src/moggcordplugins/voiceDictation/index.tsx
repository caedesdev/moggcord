...
import { getGroqKey } from "../moggcordAI/groqManager";
...
async function transcribe(blob: Blob): Promise<string> {
    ...
    if (!apiKey) {
        throw new Error("API key missing — Configure your key in Settings → MoggcordAI");
    }
    ...
    // Prompt Whisper toward dictation and away from silence hallucinations.
    form.append("prompt", "This is English voice dictation. Do not translate. Do not generate text if there is only silence.");
...
export default definePlugin({
    ...
    description: "Real-time voice dictation via Groq Whisper (free). API key shared with MoggcordAI.",
