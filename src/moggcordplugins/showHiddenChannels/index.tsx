...
export default definePlugin({
    ...
    patches: [
        ...
        // Avoid trying to fetch messages from hidden channels
        {
            ...
            replacement: [
                ...
                {
                    match: /fetchMessages(?:\s*:\s*function|\s*=|\s*)\s*\([^)]*\)\s*\{/,
        ...
        {
            find: "VOICE_CHANNEL_SELECT",
            replacement: {
                match: /selectVoiceChannel\(\w+(?:,\w+)*\)\{/,
                replace: "$& if($self.isHiddenChannel({channelId: arguments[0]}, true)) return;"
            }
        },
    ...
    LockIcon: ErrorBoundary.wrap(() => (
        <span
            ...
            style={{ color: "var(--interactive-normal)", fontSize: "16px", display: "inline-flex", alignItems: "center", justifyContent: "center", width: "20px", height: "18px" }}
            aria-hidden={true}
            role="img"
        >
            🔒
        ...
        <Tooltip text="Hidden Channel">
            {({ onMouseLeave, onMouseEnter }) => (
                <span
                    ...
                    style={{ color: "var(--interactive-normal)", fontSize: "16px", display: "inline-flex", alignItems: "center", justifyContent: "center", width: "24px", height: "24px" }}
                    aria-hidden={true}
                    role="img"
                >
                    🔒
