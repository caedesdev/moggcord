...
const LS_KEY_DATA = "MoggcordCP_data";
const LS_KEY_ENABLED = "MoggcordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "MoggcordCP_allData";
const LS_ALL_ENABLED = "MoggcordCP_allEnabled";
