...
const DoubleCallButton: UserAreaButtonFactory = ({ iconForeground }: UserAreaRenderProps) => {
    ...
    return (
        <UserAreaButton
            ...
            icon={<PhoneIcon className={`${iconForeground} ${active ? "moggcord-dc-active" : ""}`} />}
            onClick={handleClick}
        />
    );
};
            ...
            if (proto && !proto.__dc_patched) {
                ...
                proto.format = function (args: any) {
                    ...
                    if (anchorState && typeof res === "string" &&
                        ...
                        return "Channel anchored. To stay in two channels, join a second channel.";
                    }
                    return res;
                };
            }
